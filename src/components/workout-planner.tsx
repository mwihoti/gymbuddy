...
export default function WorkoutPlanner() {
  ...
  return (
    <div className="flex flex-col   items-center justify-center mx-auto p-4">
      <h1 className="text-3xl text-white font-bold mb-6">Workout Planner</h1>
      <div className="mb-6">
        <div className="flex flex-col sm:flex-row items-end gap-4">
          <div className="w-full sm:w-auto">
            <label htmlFor="muscle" className="block text-l text-cyan-400 mb-6 font-bold">
              Muscle to train
            </label>
            <input
              type="text"
              id="muscle"
              className="w-full px-16  py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
