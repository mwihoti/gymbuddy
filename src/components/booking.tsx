...
export default function BookingManagement() {
    ...
    return (
        <div className='container mx-auto px-4 py-8'>
            <h1 className='text-4xl font-bold text-center mb-8'>Manage Your Booking</h1>
                        ...
                        filteredBookings.map(booking => (
                            <tr key={booking.id}>
                                ...
                                <td className='border p-2'>
                                    ...
                                    <select value={booking.status} onChange={(e) => handleStatusChange(booking.id, e.target.value as Booking['status'])}
